...
//     image: COSMOS,
//     name: "Cloud Rasoi",
//     technologyUsed: "HTML, CSS, JavaScript, PHP and MySQL",
//     description: "This is a Hotel and Restaurant Management Portal. Here we provide different type of management like Stock, Customer and Bills",
//     url: "https://cloudrasoi.com/",
//   },
//   {
//     image: TRAVELWELL,
//     name: "99 Digital India",
//     technologyUsed: "It's a blog published using blogger.",
//     description: "This was the starting of my tech journey. Right now I'm not continue on this platform.",
//     url: "https://99digitalindia.com/",
//   },
//   {
//     image: COAST,
//     name: "Coast",
...
export const SKILLS = [
  ...
  { name: "MongoDB", initialRating: 2 },
  { name: "PHP", initialRating: 2 },
...
export const ALLSTATES = ['All','Andhra Pradesh', 'Arunachal Pradesh', 'Telangana', 'Assam', 'Bihar', 'Uttar Pradesh', 'Gujarat', 'Goa', 'Haryana', 'Himachal Pradesh', 'Jammu and Kashmir', 'Madhya Pradesh', 'Karnataka', 'Kerala', 'Maharashtra', 'Chattisgarh', 'Delhi', 'Daman and Diu', 'Dadra and Nagar Hav.', 'Manipur', 'Megalaya', 'Mizoram', 'Nagaland', 'Odisha', 'Punjab', 'Rajasthan', 'Sikkim', 'Tamil Nadu', 'Tripura', 'Jharkhand', 'Uttarakhand', 'Lakshadweep', 'Chandigarh', 'Pondicherry', 'Andaman and Nico.In.', 'West Bengal'];
